...
/**************************************************************************************/
//타이머의 비교값(compare register)에 모터 출력값을 대입해서 제어
void writeMotors() { // [1000;2000] => [125;250]
  /****************  Specific PWM Timers & Registers for the MEGA's   *******************/
  #if defined(MEGA)// [1000:2000] => [8000:16000] for timer 3 & 4 for mega 1000~2000값을 8배(<<3)해서 비교레지스터에 대입
    #if (NUMBER_MOTOR > 0) 
...
/**************************************************************************************/
void writeAllMotors(int16_t mc) {   // Sends commands to all motors 모든 모터에 같은 값을 출력
...
/**************************************************************************************/
void initOutput() { //타이머 준비하고 모터에 최소값으로 출력
...
/************************************************************************************************************/
  ...
  /****************                normalize the Motors values                ******************/
		//모터 출력값(motors values)의 최댓값을 찾아서 모터 출력값을 normalize한다는 내용인 듯.
    maxMotor=motor[0];
