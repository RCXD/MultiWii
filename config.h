...
#define SERIAL2_COM_SPEED 9600			//GPS -> 寃뚯엫�뵆�윭�뒪�뿉��
#define SERIAL3_COM_SPEED 57600			//Telemetry -> 寃뚯엫�뵆�윭�뒪�뿉��
...
#define THROTTLE_ANGLE_CORRECTION 45
...
/* Train Acro with auto recovery. Value set the point where
   Remember to activate ANGLE_MODE first!...
   A  ANGLE_MODE takes over.Value on 200 will give a very distinct transfer */
...
//http://blog.naver.com/dnfkgh33/220875348244
...
/* HW PWM Servo outputs for Arduino Mega.. moves:
  ...
  SERVO5  = pin 10 (aileron right for fixed wing)
